...
public class InMemoryMealRepository implements MealRepository {
    ...
    public Collection<Meal> getAll(Integer userId) {
        return getAll(null, null, userId);
    }

    @Override
    public Collection<Meal> getAll(LocalDate dateFrom, LocalDate dateTo, Integer userId) {
        log.info("get all meals from {} to {}, userId {}", dateFrom, dateTo, userId);
        Map<Integer, Meal> userMeals = repository.get(userId);
        return userMeals != null ? MealsUtil.getFilteredMeals(userMeals.values(), dateFrom, dateTo) :
